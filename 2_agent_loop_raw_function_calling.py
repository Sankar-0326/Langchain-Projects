...
def apply_discount(price: float, discount_tier: str) -> float :
    """Apply a discount tier to a price and returns the final price. 
    Available tiers: bronze, silver, gold."""
    print(f"    >> Executing apply_discount(price= '{price}', discount_tier= '{discount_tier}')")
    discount_percentages = {"bronze": 5, "silver": 12, "gold": 23}
    discount = discount_percentages.get(discount_tier, 0)
    return round(price * (100 - discount) * 0.01, 2)


# Difference 2: without @tool, we must Manually define JSON schema for each function.
# This is what langchain @tool decorator generates automatically.
...
tools_for_llm = [
    {
        ...
        "function": {
            ...
            "description": "Look up the price of the product in catalog",
            "parameters": {
                "type": "object",
                "properties": {
                    "product": {
                        "type": "string",
                        "description": "The product name, e.g. 'laptop', 'keyboard', 'headphones'"
                    },
                },
                "required": ["product"],
            },
    ...
    },
    {
        ...
        "function": {
            "name": "apply_discount",
            "description": "Apply a discount tier to a price and returns the final price. Available tiers: bronze, silver, gold.",
            "parameters": {
                "type": "object",
                "properties": {
                    "price": {
    ...
    messages= [
        {
            ...
            "content": (
                ...
                "You have an access to product catalog tool."
                "and a discount tool.\n\n"
                ...
                "3. Never calculate discount using math. "
...
if __name__ == "__main__" :
    ...
    print()
    result = run_agent("What is the price of the laptop after applying the gold discount?")